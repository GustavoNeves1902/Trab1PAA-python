...
def compactar_por_caractere(nome_entrada, nome_saida):
    ...
    print("Arquivo compactado por caractere com sucesso.")

def descompactar_por_caractere(nome_entrada, nome_saida):
    ...
    print("Arquivo descompactado por caractere com sucesso.")
